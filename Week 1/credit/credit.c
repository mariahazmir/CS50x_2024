...

{
    ...
    /*
    1 multiply every other digit by 2, start from the second last digit, get the products, sum up
    the digits, let it be [sum1] 2 sum up the digits that weren't multiplied by 2, let it be [sum2]
    ...
    */
    ...
    // Check for Amex
    if ((z / 10 == 3) && (z % 10 == 4 || z % 10 == 7) && i == 15)
    {
        printf("AMEX\n");
    }

    // Check for Visa
    else if ((z / 10 == 4) && (i == 13 || i == 16))
    {
        printf("VISA\n");
    }

    // Check for Mastercard
    else if ((z / 10 == 5) && (0 < z % 10 && z % 10 < 6) && i == 16)
    {
        printf("MASTERCARD\n");
    }
